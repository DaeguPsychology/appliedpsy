...
'      <img class="emblem-img" src="symbol_6.jpg" alt="대구대학교 응용심리연구소 로고"' +
...
'    <div class="foot-top">' +
'      <div class="foot-info">' +
'        <div class="foot-logo">대구대학교 응용심리연구소</div>' +
'        <p>경상북도 경산시 대구대로 201 대구대학교 사회과학관 2409호 응용심리연구소<br>' +
'           TEL 053-850-6370 · baskya@daegu.ac.kr</p>' +
'      </div>' +
...
'      </div>' +
'    </div>' +
'    <p class="copy">COPYRIGHT &copy; 2026 DAEGU UNIVERSITY CENTER FOR APPLIED PSYCHOLOGY. ALL RIGHTS RESERVED.</p>' +
'  </div>' +
'</footer>';
